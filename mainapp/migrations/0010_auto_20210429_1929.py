# Generated by Django 3.1.6 on 2021-04-29 09:29
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainapp', '0009_auto_20210429_1342'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('new', 'Новый заказ'), ('in_progress', 'Заказ в обработке'), ('is_ready', 'Заказ готов'), ('completed', 'Заказ выполнен')], default='new', max_length=20, verbose_name='Статус заказа')),
